...
<html>
    ...
    <section id="banner">
        ...
        <div class="inner">
	     ...
	     <div class="container center width-80 text"> 
	    	<div  class="element1" >
		 	 	<div class="element1-outline">	
		 			
			 		<div class="text-left">
				 		<p>Java School is designed to help new students overcome challanges, they are likely to face during learning Java language</p>
					 	<p>This online training project was created to help beginning programming students anywhere 
					 	in the world to get access to video training online. The training is sequential to take students 
					 	from the beginning level to proficiency.</p>
			
						<p>The following are the highlights of the project.</p>
					
					
						<div class="text-left">
						 	<ul>
							 	<li>To create the project framework I have utilized HTML, Spring, MYSQL and JSP pages</li>
								<li>Registration allows student to create a permanent record for login</li>
								<li>User objects are created in Spring</li>
								<li>User information as well as questions and answers for tests are stored in MySQL</li>
								<li>Java programming is used to calculate the test scores.</li>
								<li>Successful completion of a test automatically generates a completion certificate and congratulations</li>
								<li>Failure of an exam requests a student to repeat the training and then to retry.</li>
							</ul>
						</div>
						<p>I am passionate about providing quality training and hope that my site will help students everywhere to 
						quickly gain knowledge about programming.
						</p>
				</div>
			</div>
		</div>
