...
<html>
    ...
    <section id="banner">
        ...
        <div class="inner">
            <h1>Welcome to Second Lesson</h1>
        </div>
    </section>
    <div class="right">
      	<nav id="nav">
          	<a href="/" class="myButton2">Home</a>
        </nav>	
    </div>
    <div class="center lesson">
        <iframe width="750" height="500" src="https://www.youtube.com/embed/IBNQ6whVHeI" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        <a class="myButton" href="/myclass">Come back to the Class</a>
    </div>
</body>
</html>