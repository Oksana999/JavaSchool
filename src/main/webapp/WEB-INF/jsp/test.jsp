    ...
    <div class="container">
        <div class="form">
            <form:form method="POST" modelAttribute="questions" action="test">
                <table>
                    <c:forEach items="${questions.questionsAnswersList}" var="q" varStatus="status"> 
                        <tr>
                            <td colspan="3"><h2><c:out value="${q.question_id}. ${q.question}"></c:out></h2></td>
                            </tr>
                            <tr>
                                <td><form:radiobutton path="questionsAnswersList[${status.index}].right_answer" value="a" /></td>
                            <td><c:out value="${q.optionA}"></c:out></td>
                            </tr>
                            <tr>
                                <td><form:radiobutton path="questionsAnswersList[${status.index}].right_answer" value="b" /></td>
                            <td><c:out value="${q.optionB}"></c:out></td>
                            </tr>
                            <tr>
                                <td><form:radiobutton path="questionsAnswersList[${status.index}].right_answer" value="c" /></td>
